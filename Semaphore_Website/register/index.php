    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
	 ...
	 <div id="service">
	 	<div class="container" id="loginContainer">
                    <div id="loginForm">
                        <h1>Register</h1>
                        <form action="../Functions/POSTPages/AccountManagement/CreateConfirmationEmail.php" method="post">
                            <div class="form-group">
                                <input type="username" class="form-control" id="usernameField" name="username" placeholder="Username">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" id="usernameField" name="email" placeholder="Email">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" id="passwordField" name="password" placeholder="Password">
                            </div
                            <div class="form-group">
                                <input type="password" class="form-control" id="passwordField" name="passwordConfirm" placeholder="Confirm password">
                            </div>
                            <br>
                            <div class="form-group">
                                <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" placeholder="Date of birth (YYYY-MM-DD)">
                            </div>
                            <div clas="form-group">
                                <select class="form-control" name="country"><!-- Credit goes to https://www.freeformatter.com/iso-country-list-html-select.html for the list of countries in optionbox form!-->
